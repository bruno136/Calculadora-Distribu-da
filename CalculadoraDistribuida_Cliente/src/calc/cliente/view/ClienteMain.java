...
public class ClienteMain {
    ...
    public ClienteMain() {
        ...
        if (teste != null) {
            console.append("Teste de Conexão \t= " + teste);
        }
        ...
        btn_poten.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String calculo = display.getText();
                if (Util.verificaOperador(calculo)) {
    ...
    private void initialize() {
        ...
        btn_poten = new JButton("^");
        btn_poten.setBounds(226, 149, 44, 35);
        frame.getContentPane().add(btn_poten);
